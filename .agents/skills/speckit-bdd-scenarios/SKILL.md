...
metadata:
  ...
  source: bdd:commands/scenarios.md
---
...
- Use **declarative style** — describe _what_, not _how_: write "the user is authenticated" not "the user clicks the Login button and types their email"
