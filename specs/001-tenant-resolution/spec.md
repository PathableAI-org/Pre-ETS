...
- **FR-014**: Production-like association MUST be the safe behavior when local mode selection is absent; invalid mode selection MUST preserve host association and report an understandable diagnostic without using local static data.
